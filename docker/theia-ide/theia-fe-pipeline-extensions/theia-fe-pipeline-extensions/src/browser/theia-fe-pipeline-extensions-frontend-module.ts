...
import { TheiaFePipelineExtensionsCommandContribution} from './theia-fe-pipeline-extensions-contribution';

export default new ContainerModule(bind => {
    bind(CommandContribution).to(TheiaFePipelineExtensionsCommandContribution).inSingletonScope();
